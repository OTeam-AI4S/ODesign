...
from src.utils.openfold_local.data import parsers
from src.utils.openfold_local.data.msa_identifiers import (
    Identifiers,
    _extract_sequence_identifier,
    _parse_sequence_identifier,
)
from src.utils.openfold_local.data.msa_pairing import (
    CHAIN_FEATURES,
    MSA_FEATURES,
    MSA_GAP_IDX,
    MSA_PAD_VALUES,
...
try:
    from src.utils.openfold_local.data.tools import jackhmmer
except ImportError:
    print(
